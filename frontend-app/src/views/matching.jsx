...
class Matching2 extends React.Component {
    ...
    hasMatch(requests){
        ...
        while (i < requests.length){
            console.log(curRequest.timeSlotInteger, requests[i].timeSlotInteger)
            console.log(requests[i].matched)
        ...
        return (
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: '80px'}}>
                ...
                ? <div style={{ textAlign: 'center', backgroundColor: '#C0F5C3', padding: '80px' }}>
                    <p style={{ fontSize: '26px', fontWeight: 'bold'}}>Congratz, you are matched with a buddy</p>
